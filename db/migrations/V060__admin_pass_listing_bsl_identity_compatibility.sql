-- BSL databases may not carry the core public.users registry table. Keep the
-- admin pass listing usable there by resolving identities from Supabase Auth
-- and the provider-compatible user_profiles table instead.
BEGIN;
