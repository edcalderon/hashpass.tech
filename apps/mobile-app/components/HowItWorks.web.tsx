...
function Card({ card, index, dark, animate, sectionVisible }: { card: typeof cards[number]; index: number; dark: boolean; animate: boolean; sectionVisible: boolean }) {
  ...
  return <motion.article ref={ref}
    ...
    <div aria-hidden="true" className="hashpass-how-scene" style={{ height: 152, borderRadius: uiTokens.radius.media, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 24, overflow: 'hidden' }}>
