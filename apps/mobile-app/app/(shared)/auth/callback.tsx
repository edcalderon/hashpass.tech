    ...
    useEffect(() => {
        ...
        const handleAuthCallback = async () => {
            ...
            try {
                ...
                const isPasswordlessMethod = signInMethod === 'magic_link' || signInMethod === 'otp_code' || isNativePasswordlessCode || isWebPasswordlessCode;
                ...
                if (isPasswordlessMethod && isPasswordlessSupported) {
                    ...
                    // On web: if the code was generated by the native app (nativeRelay=1), the
                    // PKCE code_verifier is in the native app's AsyncStorage — not in Chrome's
                    // storage. We cannot exchange the code here. Re-attempt the native relay.
