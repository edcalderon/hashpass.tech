...
1. The in-app docs screen (button opens Storybook)
2. Direct URL to Storybook static site
3. Embedded in email links that point to the published docs or Storybook URL

## Customization

Edit the guide stories in:
- `apps/docs/docs/guides/UserOnboardingGuide.stories.tsx`
- `apps/docs/docs/guides/SpeakerOnboardingGuide.stories.tsx`
