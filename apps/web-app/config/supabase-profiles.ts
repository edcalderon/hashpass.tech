...
const PROFILES: SupabaseProfile[] = [
  {
    ...
    publicUrlEnv: ['EXPO_PUBLIC_SUPABASE_URL_DEV', 'EXPO_PUBLIC_SUPABASE_URL'],
    publicKeyEnv: ['EXPO_PUBLIC_SUPABASE_KEY_DEV', 'EXPO_PUBLIC_SUPABASE_ANON_KEY_DEV', 'EXPO_PUBLIC_SUPABASE_KEY'],
  ...
  },
  {
    ...
    publicUrlEnv: ['EXPO_PUBLIC_SUPABASE_URL_PROD', 'EXPO_PUBLIC_SUPABASE_URL'],
    publicKeyEnv: ['EXPO_PUBLIC_SUPABASE_KEY_PROD', 'EXPO_PUBLIC_SUPABASE_ANON_KEY_PROD', 'EXPO_PUBLIC_SUPABASE_KEY'],
