...
export const EVENTS: Record<string, EventConfig> = {
  ...
  'chile2026': makeTourStopConfig('chile2026', {
    ...
    agenda: [
      { id: 'chile-day1-welcome-cocktail-registration-coffee', time: '08:30-09:30', title: 'Welcome cocktail, registration, coffee & sponsor booths opening', type: 'registration' },
      { id: 'chile-day1-opening-remarks', time: '09:30-09:40', title: 'Opening remarks', type: 'keynote', speakers: ['alvaro-clarke', 'rodrigo-sainz'] },
      { id: 'chile-day1-open-finance-and-regulatory', time: '09:45-10:10', title: 'Open Finance and regulatory transformation of Chilean financial system', type: 'keynote', speakers: ['claudia-sotelo'] },
      { id: 'chile-day1-mica-regulatory-sandboxes-and', time: '10:15-10:40', title: 'MiCA, regulatory sandboxes and evolution of European financial markets', type: 'keynote', speakers: ['francisco-del-olmo'] },
      { id: 'chile-day1-digital-transformation-of-banking', time: '10:45-11:10', title: 'Digital transformation of banking and Latin American financial system evolution', type: 'keynote', speakers: ['jose-manuel-mena'] },
      { id: 'chile-day1-digital-assets-el-salvador', time: '11:15-11:40', title: 'Digital Assets, El Salvador\'s experience', type: 'keynote', speakers: ['juan-carlos-reyes'] },
      { id: 'chile-day1-building-new-financial-infrastructure', time: '11:45-12:05', title: 'Building new financial infrastructure: European perspectives', type: 'keynote', speakers: ['steffen-harting'] },
      { id: 'chile-day1-networking-coffee-lunch-sponsor', time: '12:00-13:00', title: 'Networking + Coffee lunch + sponsor booths', type: 'meal' },
      { id: 'chile-day1-virtual-asset-market-regulation', time: '13:00-13:25', title: 'Virtual asset market regulation: comparative perspectives and international evolution', type: 'keynote', speakers: ['daniel-do-nascimento-petiz'] },
      { id: 'chile-day1-panel-financial-infrastructure-and', time: '13:30-14:20', title: 'Panel: Financial infrastructure and banking system transformation', type: 'panel', speakers: ['judith-vergara', 'erick-ortiz', 'maria-luisa-acuna', 'willian-santos', 'juan-antonio-figueroa'] },
      { id: 'chile-day1-compliance-licenses-and-international', time: '14:25-14:50', title: 'Compliance, licenses and international expansion: building global financial institutions', type: 'keynote', speakers: ['camila-santana'] },
      { id: 'chile-day1-panel-new-global-financial', time: '14:55-15:45', title: 'Panel: New global financial architecture: regulation, infrastructure and system transformation', type: 'panel', speakers: ['david-diaz', 'juan-carlos-reyes', 'daniel-do-nascimento-petiz', 'francisco-del-olmo', 'renzo-alvarado'] },
      { id: 'chile-day1-extended-networking-day-1', time: '15:45-16:30', title: 'Extended networking + Day 1 closing', type: 'break' },
      { id: 'chile-day2-welcome-coffee-networking-sponsor', time: '08:30-09:30', title: 'Welcome coffee + networking + sponsor booths opening', type: 'registration' },
      { id: 'chile-day2-from-traditional-payments-to', time: '09:30-09:55', title: 'From traditional payments to new financial infrastructure: inclusion, interoperability and digital assets', type: 'keynote', speakers: ['luisa-cardenas'] },
      { id: 'chile-day2-panel-capital-markets-in', time: '10:00-10:50', title: 'Panel: Capital markets in transformation: tokenization, new digital assets and institutional adoption', type: 'panel', speakers: ['roberto-darrigrandi', 'alexandre-borelli', 'rafael-teruszkin', 'aldo-fuertes', 'antonio-sundas'] },
      { id: 'chile-day2-from-innovation-to-infrastructure', time: '10:55-11:20', title: 'From innovation to infrastructure: AI, blockchain and financial core modernization', type: 'keynote', speakers: ['juan-jose-miranda'] },
      { id: 'chile-day2-tokenization-evolution-of-the', time: '11:25-11:50', title: 'Tokenization: Evolution of the financial market', type: 'keynote', speakers: ['rodrigo-sainz'] },
      { id: 'chile-day2-stablecoins-beyond-the-dollar', time: '11:55-12:20', title: 'Stablecoins, beyond the dollar', type: 'keynote', speakers: ['guillermo-acuna'] },
      { id: 'chile-day2-networking-coffee-lunch-sponsor', time: '12:00-13:00', title: 'Networking + Coffee lunch + sponsor booths', type: 'meal' },
      { id: 'chile-day2-panel-stablecoins-as-financial', time: '13:00-13:50', title: 'Panel: Stablecoins as financial infrastructure and banking system integration: compliance risks and challenges', type: 'panel', speakers: ['juan-pablo-rodriguez', 'guido-messi', 'camila-santana', 'jose-manuel-souto', 'leandro-pereira'] },
      { id: 'chile-day2-stablecoins-and-new-global', time: '13:55-14:20', title: 'Stablecoins and new global monetary infrastructure', type: 'keynote', speakers: ['nathaly-diniz'] },
      { id: 'chile-day2-panel-new-global-financial', time: '14:25-15:15', title: 'Panel: New global financial architecture: cross-border payments, stablecoins and tokenized financial infrastructure evolution', type: 'panel', speakers: ['camilo-romero', 'omar-castelblanco', 'sarina-gowland', 'jaime-bunzli', 'bernardo-janot'] },
      { id: 'chile-day2-aml-monitoring-and-fraud', time: '15:20-15:45', title: 'AML monitoring and fraud prevention synergies in the compliance world', type: 'keynote', speakers: ['willian-santos'] },
      { id: 'chile-day2-extended-networking-day-2', time: '15:45-16:30', title: 'Extended networking + Day 2 closing', type: 'break' },
      { id: 'chile-day3-welcome-coffee-networking-sponsor', time: '08:30-09:30', title: 'Welcome coffee + networking + sponsor booths opening', type: 'registration' },
      { id: 'chile-day3-chile-facing-the-new', time: '09:30-09:55', title: 'Chile facing the new global financial architecture', type: 'keynote', speakers: ['alberto-naudon'] },
      { id: 'chile-day3-panel-digital-assets-architecture', time: '10:00-10:50', title: 'Panel: Digital assets architecture: regulation, market and institutional adoption', type: 'panel', speakers: ['paula-bermudez', 'daniel-hernandez', 'sylvia-sanchez', 'ximena-rojas', 'ignacio-araya'] },
      { id: 'chile-day3-fireside-chat-from-innovation', time: '10:55-11:20', title: 'Fireside chat: From innovation to infrastructure: building programmable financial systems', type: 'panel', speakers: ['albi-rodriguez', 'francisco-del-olmo'] },
      { id: 'chile-day3-panel-convergence-between-banking', time: '11:25-12:15', title: 'Panel: Convergence between banking, capital markets and digital assets: emerging models and opportunities for the financial system', type: 'panel', speakers: ['mauricio-jara', 'juan-pablo-cordoba', 'luisa-cardenas', 'regina-pedroso', 'vicente-lazen'] },
      { id: 'chile-day3-panel-financial-system-2030', time: '12:20-13:10', title: 'Panel: Financial System 2030: how will money, capital and financial infrastructure be redefined?', type: 'panel', speakers: ['alvaro-clarke', 'jose-gabriel-carrasco', 'alexis-franco', 'guillermo-acuna', 'claudio-calderon'] },
      { id: 'chile-day3-conclusions-and-closing', time: '13:15-13:30', title: 'Conclusions and closing', type: 'keynote', speakers: ['mauricio-jara', 'rodrigo-sainz'] },
      { id: 'chile-day1-workshop-1', time: '08:00-09:15', title: 'Workshop: Introduction Business', type: 'keynote', speakers: ['alberto-naudon'] },
      { id: 'chile-day1-workshop-2', time: '09:15-10:20', title: 'Workshop: Introduction Business II', type: 'keynote', speakers: ['alberto-naudon'] },
      { id: 'chile-day2-workshop-1', time: '08:00-09:15', title: 'Workshop: Introduction Business III', type: 'keynote', speakers: ['alberto-naudon'] },
      { id: 'chile-day2-workshop-2', time: '09:15-10:20', title: 'Workshop: Introduction Business IV', type: 'keynote', speakers: ['alberto-naudon'] },
      { id: 'chile-day3-workshop-1', time: '08:00-09:15', title: 'Workshop: Introduction Business', type: 'keynote', speakers: ['alberto-naudon'] },
    ],
  }),
